...
public class java2 {
	...
	public static void main(String[] args) {
		...
		// 1. Creating a Single Value Storage 
		byte age = 20; 
		// age is the name of storage  -> also known as variable 
		
        // byte is the type of storage 
		...
		//2. Update the value of age i.e. update the storage 
		age = 35;
